...
!function (a) {
    ...
    function Qa(c, e) {
        ...
        var V, W, Y, Z, $, _, aa, ba = T.isFetchNeeded, ca = T.fetchEvents, da = T.fetchEventSources, ea = c[0], fa = {}, ga = 0, ha = [];
    ...
    function Ua() {
        ...
        function i(b, c) {
            ...
            if (g) a.isFunction(g) ? (U.pushLoading(), g.call(U, W.clone(), X.clone(), U.options.timezone, function (a) {
                ...
                if (h) {
                    ...
                    var n = a.extend({}, j || {}), o = ba(b.startParam, U.options.startParam), p = ba(b.endParam, U.options.endParam), q = ba(b.timezoneParam, U.options.timezoneParam);
        ...
        function K(a, b) {
            var c = b.source || {}, d = ba(b.constraint, c.constraint, U.options.eventConstraint), e = ba(b.overlap, c.overlap, U.options.eventOverlap);
            return Q(a, d, e, b)
        }

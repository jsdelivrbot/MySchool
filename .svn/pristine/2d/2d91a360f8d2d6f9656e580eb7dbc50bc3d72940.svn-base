...
(function (m, ma) {
    ...
    function Zb(a, b) {
        function e() {
            q = b.theme ? "ui" : "fc";
            if (b.header)return Q = m("<table class='fc-header' style='width:100%'/>").append(m("<tr/>").append(f("left")).append(f("center")).append())
        }
                    ...
                    if (sa == "title") {
                        ...
                        if (ha) {
                            ...
                            var da = jb(b.buttonText, sa), na = m("<span  class='fc-button fc-button-" + sa + " " + q + "-state-default'><span class='fc-button-inner'><span class='fc-button-content'>" + (ra ? "<span class='fc-icon-wrap'><span class='ui-icon ui-icon-" +
                                    ra + "'/></span>" : da) + "</span></span></span></span></span>");
                            if (na) {
                                na.click(function () {
    ...
    function sb(a, b, e) {
        ...
        function g(w,
            ...
            y(E);
            Y = m("<div style='text-align: center;position:absolute;z-index:8;top:0;left:0'/>").appendTo(a)
        }

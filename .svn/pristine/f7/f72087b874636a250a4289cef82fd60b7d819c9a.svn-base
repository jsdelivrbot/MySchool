...
exports.default = {
  install: function install(Vue) {
    ...
    [_transitions.ExpandTransition, _transitions.FadeTransition, _transitions.SlideTopTransition, _transitions.SlideBottomTransition, _transitions.ScaleTransition].forEach(function (transition) {
